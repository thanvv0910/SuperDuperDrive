...
class CloudStorageApplicationTests {
	...
	private CloudStorageApplication application;
	...
	public void beforeEach() {
		...
		application = new CloudStorageApplication();
	...
	@Test
	public void testHomePageNotAccessWithoutLogin(){
	...
	public void testUserSignupLoginLogout() throws InterruptedException {
		// signup the user
		doMockSignUp("Than","Vu","username","password");
		// login the user
	...
	public void editNote() throws InterruptedException {
		...
		webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.id("noteTable")));
		Assertions.assertTrue(driver.findElement(By.id("noteTable")).getText().contains("edited description"));
	}
	...
	public void deleteNote() throws InterruptedException {
		...
		List<WebElement> notesList = notesTable.findElements(By.tagName("note"));
	...
	public void addCredential() throws InterruptedException {
		...
		WebDriverWait webDriverWait = new WebDriverWait(driver, 2);
		String inputCredentialPassword = "new password";
		...
		Assertions.assertNotEquals(driver.findElement(By.id("credentialTable")).getText(), inputCredentialPassword);
	}
	...
	public void editCredentials() throws InterruptedException {
		...
		// check changes
		webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.id("credentialTable")));
		Assertions.assertTrue(driver.findElement(By.id("credentialTable")).getText().contains("https://facebook.com/"));

		// Verify that the viewable password is unencrypted
		Assertions.assertNotEquals(driver.findElement(By.id("credentialTable")).getText(), inputPassword);
	}
	...
	public void deleteCredentials() throws InterruptedException {
		...
		List<WebElement> credList = credentialTable.findElements(By.tagName("credential"));
